...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Navavi Chai & Cafe — Amrutulya Chai Franchise & Premixes" },
      {
        name: "description",
        content:
          "Navavi Chai & Cafe — authentic Indian tea, coffee and instant premixes. Amrutulya chai franchise opportunities across India.",
      },
      { property: "og:site_name", content: "Navavi Chai & Cafe" },
